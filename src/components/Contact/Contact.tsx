                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="my-6">
                        ...
                        <Swiper
                            ...
                            modules={[Pagination]}
                        >
                            <SwiperSlide className="bg-white shadow-2xl">
                                <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
                                    <figure className="max-w-screen-md mx-auto">
                                        ...
                                        <blockquote>
                                            <p className="text-2xl font-medium text-gray-900">"Flowbite is just awesome. It contains tons of predesigned components and pages starting from login screen to complex dashboard. Perfect choice for your next SaaS application."</p>
                                        </blockquote>
